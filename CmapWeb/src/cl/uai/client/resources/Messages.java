...
public interface Messages extends ConstantsWithLookup {
	...
	public String DoubleClickChangeTitle();
	public String HelpAddConcepts();
	public String HelpAddRelationships();
	public String HelpButton();
	public String HelpRenameDelete();
	public String HelpTitle();
	public String InvalidConceptName();
	public String NewConceptMap();
	public String Redo();
	public String RenameConcept();
	public String Save();
	public String Undo();
